...
const List = () => {
    const [faqs, setfaqs] = useState([
        {
            question: "Сколько стоит доставка? – «Информация о доставке»",
            answer: "Доставка осуществляется в пределах административных границ городов. Бесплатная доставка при сумме заказа от 3000 рублей по территории России.Срок доставки от 1 до 3 рабочих дней.* Стоимость порога бесплатной доставки может меняться в зависимости от населенного пункта и выбранной транспортной компании.Окончательная стоимость доставки доступна при оформлении заказа.",
            open: false
        },
        {
            question: "Можно ли получить скидку? - «программа лояльности»",
